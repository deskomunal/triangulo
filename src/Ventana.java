...
public class Ventana extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==jbt_boton1){//llamo a get source la fuente d deonde se produjo el evento si se coincide con el boton es por que se hizo click en el boton1
			int cont=0;
			int aux=0;
			int a,b,c;
			...
			if(aux==1){
				...
				JOptionPane.showMessageDialog(null, "los lados no componen un triangulo");
			}
